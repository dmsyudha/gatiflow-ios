...
divider()
print("  GatiFlow SDK — Example App (macOS)")
divider()
...
GatiFlow.shared.setUserId("user_demo_42")
...
GatiFlow.shared.analytics?.trackEvent("app_opened")
print("    ✓ app_opened")

GatiFlow.shared.analytics?.trackEvent("screen_viewed", properties: [
    "screen_name": "home",
...
GatiFlow.shared.analytics?.trackEvent("this_event_is_dropped")
print("    Analytics disabled — event above is silently dropped")
GatiFlow.shared.analytics?.setEnabled(true)
